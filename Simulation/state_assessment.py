...
def render_state_assessment_prompt(
    ...
    *,
    ...
    current_day_context: Mapping[str, Any],
    planned_physical_activity: Any | None,
    physical_activity_decision: str,
    ...
    values = {
        ...
        "current_day_context": current_day_context,
        "planned_physical_activity": planned_physical_activity,
        "physical_activity_decision": physical_activity_decision,
...
def run_state_assessment(
    *,
    ...
    rendered_prompt = render_state_assessment_prompt(
        ...
        current_day_context=current_day_context,
        planned_physical_activity=planned_physical_activity,
        physical_activity_decision=str(pa_decision["decision_label"]),
        decision_rationale=str(pa_decision["rationale_short"]),
        current_simulated_diary_entry=str(pa_decision["diary_entry"]),
